    ...
    <div class="container">
      ...
      <div class="menu" :class="{ 'menu-closed': !isSidebarOpen }">
        <table class="menu-container" border="0">
          <tr class="menu-row">
            <td class="menu-btn menu-icon-dashbord" :class="{ 'menu-active': isActive('/doctor/dashboard') }">
              <router-link to="/doctor/dashboard" class="non-style-link-menu">
                <div class="menu-item">
          ...
          <tr class="menu-row">
            <td class="menu-btn menu-icon-schedule" :class="{ 'menu-active': isActive('/doctor/schedule') }">
              <router-link to="/doctor/schedule" class="non-style-link-menu">
                <div class="menu-item">
          ...
          <tr class="menu-spacer"><td></td></tr>
          <tr class="menu-row">
            <td class="menu-btn menu-icon-appointment" :class="{ 'menu-active': isActive('/doctor/appointment') }">
              <router-link to="/doctor/appointment" class="non-style-link-menu">
                <div class="menu-item">
                  <i class="fas fa-user-md"></i>
